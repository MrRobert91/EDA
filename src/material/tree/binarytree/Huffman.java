...
public class Huffman {
    ...
    public Huffman (String sentence){
        ...
        System.out.println("El almacen de nodos tiene n tamano de " + almacen.size());
        ...
        System.out.println("Tamano: "+bosque.size());
        ...
        for (HuffmanNode c : almacen){
            System.out.println("Letra: " + c.getCharacter()+ " Codigo: "+c.getCode());
        }
    ...
    public static void main(String[] args) throws IOException, NoSuchFieldException {
       ...
       Huffman huffman = new Huffman("SUSIE SAYS IT IS EASY");
